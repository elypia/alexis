...
public class GreetingModule extends CommandHandler {
    ...
    @Command(aliases = "message", help = "Set a greeting messages for the given event and account type.")
    ...
    @Command(aliases = "channel", help = "Change the channel that you display bot messages without affecting other settings.")
