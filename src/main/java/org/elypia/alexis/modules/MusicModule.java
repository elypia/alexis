...
import org.elypia.alexis.entities.embedded.MusicSettings;
import org.elypia.alexis.services.youtube.YouTubeService;
import org.elypia.alexis.sound.*;
...
public class MusicModule implements Handler {
	 ...
	 */
	private Map<Long, SoundPlayer> guildPlayers;
...
//	}
	...
	@Command(id = "Sync Channel Name with Track", aliases = {"sync", "rename"}, help = "Should ChatBot append the currently playing track to the current voice channel's name?")
